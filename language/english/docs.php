...
$docs_lang     = '_DOC_' . strtoupper($moduleDirName);
...
define($docs_lang . '_DOC_1', "1. If 'show company' is set to yes in the preferences, when a user
...
page. ");
define($docs_lang . '_DOC_2', "2. After a user adds their company there will be a new link on the Jobs
front page 'view your listings' with their company listed below.");
define($docs_lang . '_DOC_3', "3. To edit their company info they will click on their company link
...
define($docs_lang . '_DOC_4', '4. On the add company page the user can add other users that can modify
their listings.');

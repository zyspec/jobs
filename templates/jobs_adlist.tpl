            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                <tr>
                    <{if $xoops_isadmin}>
                        <td class="head"></td>
                    <{/if}>
                    <td class="head" width="20%"><{$last_head_title}></td>
                    <{if $show_company == true}>
                        <td class="head" width="20%" align="center"><{$last_head_company}></td>
                    <{/if}>
                    <td align="center" class="head" width="20%"><{$last_head_date}></td>
                    <td class="head" align="center" width="20%"><{$last_head_local}></td>
                    <td align="center" class="head" width="15%"><{$last_head_views}></td>
                </tr>
            </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                    <tr class="<{cycle values=" odd,even"}>">
                        <{if $xoops_isadmin}>
                            <td><{$item.admin}></td>
                        <{/if}>
                        <td width="20%"><b><{$item.title}></b> <{$item.new}><br>
                            <{$item.type}>
                        </td>
                        <{if $show_company == true}>
                            <td width="20%" align="center"><{$item.company}></td>
                        <{/if}>

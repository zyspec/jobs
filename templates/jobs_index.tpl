            ...
            <tr>
                <td align="center" class="even">
                    <table class="outer" cellspacing="0" style="width:50%;">
                        ...
                        <tr>
                            <td class="odd" align="center"><{$confirm_ads}><{if $show_resume == true}>
                                    <br>
                                    <{$confirm_resume}><{/if}></td>
                        </tr>
                        </td>
                    </table>
            </tr>
...
<table cellspacing="1" class="outer" style="width:100%;">
    <tr>
        <{if $use_resumes == 1}>
            <td class="odd" align="center" valign="top" width="40%"><br><{$index_head}><br><{if $jobs_submitter}>
            <br><{$add_listing}><{/if}></td>
            <{if $istheirs == 1}>
                <td class="odd" align="center" valign="top" width="20%">
                <br>
                <b><{$member_intro}></b>
                <br>
                <{foreach item=comp from=$companies}>
                    <a href="<{$comp_listurl}><{$comp.comp_id}>"><{$comp.comp_name}></a>
                    <br>
                <{/foreach}></td><{/if}>


            <td class="odd" align="center" valign="top" width="40%">
            <br>
            <{$show_res_index}>
            <br>
            <{$show_resume}>
        ...
        <{if $use_resumes == 0}>
            <td class="odd" align="center" valign="top" width="50%"><br><{$index_head}><br><{if $jobs_submitter}>
            <br><{$add_listing}><{/if}></td>
            <{if $istheirs == 1}>
                <td class="odd" align="center" valign="top" width="50%">
                <br>
                <b><{$member_intro}></b>
                <br>
                <{foreach item=comp from=$companies}>
...
<table cellspacing="1" class="head" style="width:100%;">
    <tr>
        <td align="center" class="odd">
            <{$about_new_listings}><{$how_new}> <{$days}>
        </td>
    </tr>
</table>
                        ...
                        <tr>
                            <td class="head" valign="top" align="center">
                                <{if $category.image != ""}>
                                    <{$category.image}>
                                <{/if}><br>
                                <a href="<{$xoops_url}>/modules/jobs/jobscat.php?cid=<{$category.id}>"><b><{$category.title}></b></a><br>
                                (<{$category.totallisting}>)&nbsp;<{$category.new}>
                            </td>
                        </tr>
                        <tr>
...
<{include file="db:jobs_adlist.tpl" comment=$comment}>

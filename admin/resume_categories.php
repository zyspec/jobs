...
switch ($op) {
        ...
        function resumeCategoryDisplayChildren($cid = 0, $category_arr, $prefix = '', $order = '', &$class)
        {
            ...
            foreach (array_keys($category_arr) as $i) {
                ...
                echo "<td align='center' width='10%'>
                        <a href='resume_categories.php?op=edit_category&cid=" . $category_arr[$i]->getVar('cid') . "'><img src=" . $pathIcon16 . "/edit.png alt='" . _EDIT . "' title='" . _EDIT . "'></a>
    ...
    case 'new_category':
        ...
        //$adminObject->addItemButton(_AM_JOBS_RES_CATEGORYLIST, 'resume_categories.php?op=list', 'list');
